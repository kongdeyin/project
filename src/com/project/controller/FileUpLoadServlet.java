		...
		try {
			...
			for(FileItem fi : files){
				if(fi.isFormField()){
					...
					if(".jpg".equalsIgnoreCase(suffix) || ".png".equalsIgnoreCase(suffix) || ".gif".equalsIgnoreCase(suffix) || ".jpeg".equalsIgnoreCase(suffix) || ".bmp".equalsIgnoreCase(suffix) || ".icon".equalsIgnoreCase(suffix)){
