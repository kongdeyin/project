...
<html>
	<head>
		<meta charset="UTF-8">
		<title>铜雀台整形美容医院客户关系管理系统登录</title>
	...
	<body>
		...
		<div class="login">
			...
			<form action="login.do?methodName=login" method="post">
				...
				<input type="button" class="btn btn-primary btn-block btn-large" onclick="login();" value="登录"  />
				<input type="reset" class="btn btn-primary btn-block btn-large" style="margin-top: 10px" value="重置" />
			</form>
		</div>
